...
void _articulado::draw_asiento(GLenum mode, float r1, float g1, float b1, float r2, float g2, float b2, int grosor, bool ajedrez){
    glPushMatrix();
        ...
        this->draw_bases(mode, r1, g1, b1, r2, g2, b2, grosor, ajedrez);
    glPopMatrix();
}
...
void _articulado::draw_bases(GLenum mode, float r1, float g1, float b1, float r2, float g2, float b2, int grosor, bool ajedrez){
    glPushMatrix();
